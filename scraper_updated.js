...
function predict(draws) {
  ...
  // ── KESİN 6: CONTEXT BAZLI TABLO (6459 çekiliş analizi) ──
  // Önceki 2 turun rengi + önceki turun OU → ilk 20'ye en sık giren 6 sayı
  // Backtest: %21.4 6/6 oranı
  var CONTEXT_C6 = {
    'Kahve_Kahve_OVER': [6,8,10,13,29,45],
    'Kahve_Kahve_UNDER': [14,25,31,32,34,44],
    'Kahve_Kirmizi_OVER': [9,10,14,15,25,34],
    'Kahve_Kirmizi_UNDER': [4,21,27,33,44,47],
    'Kahve_Mavi_OVER': [3,7,17,18,25,30],
    'Kahve_Mavi_UNDER': [1,6,19,21,35,46],
    'Kahve_Mor_OVER': [2,8,24,25,38,41],
    'Kahve_Mor_UNDER': [4,19,23,24,30,40],
    'Kahve_Sari_OVER': [5,6,9,37,42,47],
    'Kahve_Sari_UNDER': [6,21,26,31,38,40],
    'Kahve_Siyah_OVER': [1,13,26,30,41,47],
    'Kahve_Siyah_UNDER': [9,11,16,34,46,47],
    'Kahve_Turuncu_OVER': [2,14,24,40,42,46],
    'Kahve_Turuncu_UNDER': [5,14,27,35,42,47],
    'Kahve_Yesil_OVER': [5,10,11,17,34,39],
    'Kahve_Yesil_UNDER': [2,8,24,25,35,36],
    'Kirmizi_Kahve_OVER': [5,22,29,30,32,48],
    'Kirmizi_Kahve_UNDER': [11,20,22,34,40,44],
    'Kirmizi_Kirmizi_OVER': [4,11,14,19,24,39],
    'Kirmizi_Kirmizi_UNDER': [25,27,29,35,41,46],
    'Kirmizi_Mavi_OVER': [5,8,12,37,39,46],
    'Kirmizi_Mavi_UNDER': [11,15,18,31,46,48],
    'Kirmizi_Mor_OVER': [2,3,20,28,42,43],
    'Kirmizi_Mor_UNDER': [3,12,14,20,28,31],
    'Kirmizi_Sari_OVER': [7,24,29,38,41,46],
    'Kirmizi_Sari_UNDER': [7,26,39,45,46,48],
    'Kirmizi_Siyah_OVER': [18,20,24,27,40,42],
    'Kirmizi_Siyah_UNDER': [6,15,21,31,32,48],
    'Kirmizi_Turuncu_OVER': [3,18,29,32,36,45],
    'Kirmizi_Turuncu_UNDER': [6,16,33,42,43,48],
    'Kirmizi_Yesil_OVER': [2,7,11,13,30,48],
    'Kirmizi_Yesil_UNDER': [1,5,14,17,19,32],
    'Mavi_Kahve_OVER': [5,18,19,31,33,40],
    'Mavi_Kahve_UNDER': [1,2,16,17,24,44],
    'Mavi_Kirmizi_OVER': [1,26,32,44,47,48],
    'Mavi_Kirmizi_UNDER': [8,23,32,35,40,48],
    'Mavi_Mavi_OVER': [5,8,9,14,42,47],
    'Mavi_Mavi_UNDER': [4,8,33,37,43,47],
    'Mavi_Mor_OVER': [6,24,27,30,38,48],
    'Mavi_Mor_UNDER': [23,25,30,31,33,38],
    'Mavi_Sari_OVER': [8,14,20,21,43,44],
    'Mavi_Sari_UNDER': [21,29,33,35,46,48],
    'Mavi_Siyah_OVER': [8,14,18,21,36,46],
    'Mavi_Siyah_UNDER': [3,17,22,23,39,47],
    'Mavi_Turuncu_OVER': [11,31,37,38,41,43],
    'Mavi_Turuncu_UNDER': [1,6,9,27,33,34],
    'Mavi_Yesil_OVER': [15,19,25,29,40,41],
    'Mavi_Yesil_UNDER': [5,8,12,22,35,38],
    'Mor_Kahve_OVER': [2,3,4,21,28,41],
    'Mor_Kahve_UNDER': [10,19,23,31,32,35],
    'Mor_Kirmizi_OVER': [1,10,13,16,36,37],
    'Mor_Kirmizi_UNDER': [4,10,12,14,41,47],
    'Mor_Mavi_OVER': [2,19,31,33,39,47],
    'Mor_Mavi_UNDER': [7,12,13,17,25,46],
    'Mor_Mor_OVER': [4,9,30,31,32,41],
    'Mor_Mor_UNDER': [15,19,28,30,41,46],
    'Mor_Sari_OVER': [2,3,15,16,27,44],
    'Mor_Sari_UNDER': [23,27,30,41,43,47],
    'Mor_Siyah_OVER': [6,9,12,39,41,45],
    'Mor_Siyah_UNDER': [6,9,15,17,30,38],
    'Mor_Turuncu_OVER': [2,12,24,29,37,40],
    'Mor_Turuncu_UNDER': [7,13,18,21,23,46],
    'Mor_Yesil_OVER': [6,31,36,45,46,48],
    'Mor_Yesil_UNDER': [14,24,25,31,39,43],
    'Sari_Kahve_OVER': [2,7,12,39,41,43],
    'Sari_Kahve_UNDER': [3,27,32,34,35,42],
    'Sari_Kirmizi_OVER': [19,22,23,32,43,46],
    'Sari_Kirmizi_UNDER': [11,25,33,37,40,48],
    'Sari_Mavi_OVER': [2,13,40,41,42,48],
    'Sari_Mavi_UNDER': [6,9,31,34,42,48],
    'Sari_Mor_OVER': [14,29,32,33,39,46],
    'Sari_Mor_UNDER': [3,5,12,32,46,48],
    'Sari_Sari_OVER': [2,9,26,37,41,42],
    'Sari_Sari_UNDER': [2,6,10,12,15,21],
    'Sari_Siyah_OVER': [11,22,25,33,36,45],
    'Sari_Siyah_UNDER': [18,31,35,40,43,47],
    'Sari_Turuncu_OVER': [4,18,30,39,44,46],
    'Sari_Turuncu_UNDER': [2,5,26,35,43,48],
    'Sari_Yesil_OVER': [1,16,22,26,32,47],
    'Sari_Yesil_UNDER': [10,18,26,27,38,47],
    'Siyah_Kahve_OVER': [1,19,22,27,34,40],
    'Siyah_Kahve_UNDER': [10,27,30,45,46,48],
    'Siyah_Kirmizi_OVER': [1,4,15,16,23,26],
    'Siyah_Kirmizi_UNDER': [4,9,15,19,38,47],
    'Siyah_Mavi_OVER': [7,26,33,35,41,46],
    'Siyah_Mavi_UNDER': [3,12,14,23,27,37],
    'Siyah_Mor_OVER': [1,11,16,38,39,43],
    'Siyah_Mor_UNDER': [2,11,23,26,33,43],
    'Siyah_Sari_OVER': [2,6,19,30,41,42],
    'Siyah_Sari_UNDER': [1,16,27,34,35,38],
    'Siyah_Siyah_OVER': [13,15,17,30,32,35],
    'Siyah_Siyah_UNDER': [2,8,11,13,18,36],
    'Siyah_Turuncu_OVER': [9,19,29,36,39,40],
    'Siyah_Turuncu_UNDER': [2,15,20,24,30,31],
    'Siyah_Yesil_OVER': [3,17,20,21,40,42],
    'Siyah_Yesil_UNDER': [8,9,10,37,38,43],
    'Turuncu_Kahve_OVER': [1,3,4,12,30,41],
    'Turuncu_Kahve_UNDER': [2,5,8,11,23,41],
    'Turuncu_Kirmizi_OVER': [3,23,25,39,42,48],
    'Turuncu_Kirmizi_UNDER': [3,5,12,22,33,45],
    'Turuncu_Mavi_OVER': [4,14,15,17,38,43],
    'Turuncu_Mavi_UNDER': [6,17,26,38,43,45],
    'Turuncu_Mor_OVER': [11,13,24,30,31,32],
    'Turuncu_Mor_UNDER': [2,5,6,7,25,32],
    'Turuncu_Sari_OVER': [7,17,22,26,33,43],
    'Turuncu_Sari_UNDER': [7,16,25,38,43,47],
    'Turuncu_Siyah_OVER': [13,25,26,39,40,46],
    'Turuncu_Siyah_UNDER': [17,28,31,32,41,42],
    'Turuncu_Turuncu_OVER': [5,24,35,38,40,47],
    'Turuncu_Turuncu_UNDER': [1,4,7,20,24,33],
    'Turuncu_Yesil_OVER': [4,13,33,37,39,46],
    'Turuncu_Yesil_UNDER': [1,18,19,40,45,48],
    'Yesil_Kahve_OVER': [3,21,32,40,45,47],
    'Yesil_Kahve_UNDER': [3,23,28,35,38,41],
    'Yesil_Kirmizi_OVER': [2,14,18,27,35,37],
    'Yesil_Kirmizi_UNDER': [8,9,27,35,41,42],
    'Yesil_Mavi_OVER': [2,3,10,19,40,47],
    'Yesil_Mavi_UNDER': [14,27,29,35,36,40],
    'Yesil_Mor_OVER': [4,9,23,25,34,42],
    'Yesil_Mor_UNDER': [3,10,26,33,41,45],
    'Yesil_Sari_OVER': [3,12,23,32,40,45],
    'Yesil_Sari_UNDER': [18,20,35,45,47,48],
    'Yesil_Siyah_OVER': [3,9,10,14,31,34],
    'Yesil_Siyah_UNDER': [31,32,41,44,45,48],
    'Yesil_Turuncu_OVER': [1,34,35,36,37,46],
    'Yesil_Turuncu_UNDER': [2,5,22,24,43,46],
    'Yesil_Yesil_OVER': [2,6,22,31,33,38],
    'Yesil_Yesil_UNDER': [27,30,33,34,41,42]
  };

  // Context key: 2 tur öncesi renk + 1 tur öncesi renk + 1 tur öncesi OU
  var prevColor2 = colorList[1] || '';
  var prevOU = ouList[0] || '';
  var contextKey = prevColor2 + '_' + (prevColor||'') + '_' + prevOU;
  var c6Context = CONTEXT_C6[contextKey];

  if (c6Context && c6Context.length === 6) {
    result.certain6 = c6Context.slice().sort(function(a,b){return a-b;});
  } else {
