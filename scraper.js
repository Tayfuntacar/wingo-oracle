...
function predict(draws) {
  ...
  // ── KESİN 6: MS+Renk → İlk 15'e en sık giren sayılar (2652 çekiliş) ──
  // Backtest: %18.0 6/6 (her 5.6 turda 1), ROI +%95, ilk 15'te 7 kez
  var MS_RENK_ILK15_C6 = {
    '949_Kahve':[21,5,13,36,47,1],'949_Mavi':[19,6,25,35,48,20],
    '949_Mor':[48,1,25,46,2,8],'949_Sari':[9,32,41,11,42,7],
    '949_Turuncu':[22,6,9,38,7,8],'949_Yesil':[1,34,2,10,13,32],
    '950_Kahve':[37,2,35,1,43,18],'950_Kirmizi':[44,4,48,42,1,28],
    '950_Mavi':[3,19,43,35,11,27],'950_Mor':[8,40,20,24,26,4],
    '950_Sari':[17,12,38,20,41,19],'950_Siyah':[14,47,23,31,30,11],
    '950_Turuncu':[30,46,14,38,22,28],'950_Yesil':[42,34,18,2,25,6],
    '951_Kahve':[13,5,37,12,29,25],'951_Kirmizi':[28,12,42,4,36,44],
    '951_Mavi':[8,12,19,11,3,16],'951_Mor':[39,24,32,47,25,40],
    '951_Sari':[1,17,41,9,34,37],'951_Siyah':[7,31,42,39,2,34],
    '951_Turuncu':[30,36,46,22,42,18],'951_Yesil':[10,2,4,42,6,18],
    '952_Kahve':[21,7,13,29,45,11],'952_Kirmizi':[28,36,4,5,20,14],
    '952_Mavi':[43,3,18,35,6,21],'952_Mor':[8,24,36,3,22,30],
    '952_Sari':[37,9,40,29,33,5],'952_Siyah':[6,23,1,10,15,32],
    '952_Turuncu':[28,14,22,30,6,41],'952_Yesil':[24,42,2,30,34,38],
    '953_Mavi':[5,10,19,20,29,35],'953_Siyah':[22,27,47,31,37,1],
    '953_Yesil':[10,33,17,20,41,46]
  };
  var RENK_ILK15_C6 = {
    'Kahve':[13,37,21,29,5,45],'Kirmizi':[4,36,28,20,42,25],
    'Mavi':[43,35,3,19,11,27],'Mor':[24,8,32,40,48,25],
    'Sari':[25,1,41,9,33,17],'Siyah':[47,39,31,7,23,42],
    'Turuncu':[30,22,46,14,38,6],'Yesil':[42,10,34,2,18,30]
  };

  var msRenkKey = predMs + '_' + predColor;
  var c6Arr = MS_RENK_ILK15_C6[msRenkKey] || RENK_ILK15_C6[predColor] || [25,1,41,9,33,17];
