...
function startDashboard() {
  ...
  app.get('/', function(req, res) {
    ...
    h += 'h+="<div style=\'margin-top:12px\'>";'
    h += '';
    h += 'h+="<div style=\'display:flex;flex-wrap:wrap;gap:10px\'>";'
    ...
    h += 'h+="<div style=\'text-align:center;width:calc(25% - 6px)\'>";'
    h += 'h+="<div style=\'text-align:center\'>";'
    h += 'h+="<div style=\'font-size:8px;color:#aab0c4;margin-top:2px\'>"+rcn.slice(0,3)+"</div>";'
    h += '';
    h += '});'
    h += 'h+="</div>";'
