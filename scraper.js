...
function startDashboard() {
  ...
  app.get('/', function(req, res) {
    ...
    h += 'h+="<div style=\'margin-top:14px;margin-bottom:4px;display:flex;flex-wrap:nowrap;gap:4px;justify-content:space-between\'>";'
    ...
    h += 'h+="<div style=\'width:32px;height:32px;border-radius:50%;background:"+rbg+";opacity:0.75;border:"+brd+";display:inline-flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;color:"+tc+"\'>"+(rc10===0?"0":rc10)+"</div>";'
    h += '});'
    h += 'h+="</div>";'
