...
function startDashboard() {
  ...
  app.get('/', function(req, res) {
    ...
    h += 'h+="<div style=\'margin-top:14px;display:flex;flex-wrap:wrap;gap:10px\'>";'
    ...
    h += 'h+="<div style=\'width:38px;height:38px;border-radius:50%;background:"+rbg+";opacity:0.75;border:"+brd+";display:inline-flex;align-items:center;justify-content:center;font-size:13px;font-weight:800;color:"+tc+"\'>"+(rc10===0?"0":rc10)+"</div>";'
    h += '});'
    h += 'h+="</div>";'
