...
function predict(draws) {
  ...
  var MS_BAD_88    = {948:1, 960:1, 962:1, 965:1, 956:1};
  ...
  var MS_77_SIGNAL = {948:15.4, 959:15.2, 961:15.2, 962:13.0, 964:13.3};
  ...
  var MS_OU_OVER  = {959:1, 960:1, 961:1, 962:1, 965:1};
  ...
  // Saf tekrar oranı (test: en iyi performans, 1362 çekiliş)
  var certain6List = c6Scored.slice(0,6);
