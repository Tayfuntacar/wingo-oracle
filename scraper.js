...
function predict(draws) {
  ...
  // ── KESİN 6: MEVCUT MS+Renk+OU → SONRAKİ çekilişin ilk 20'sinde en sık çıkan sayılar ──
  // 2652 çekiliş: %24.1 6/6 (her 4.1 turda 1), ROI +%383
  // Anahtar: MEVCUT çekilişin özellikleri (predMs = şimdiki MS, predColor = şimdiki renk)
  var CURR_TO_NEXT_C6 = {
    '949_Kahve_OVER':[34,41,12,18,37,48],'949_Kahve_UNDER':[29,8,20,21,46,3],
    '949_Kirmizi_OVER':[21,6,19,37,33,44],'949_Kirmizi_UNDER':[25,30,34,4,6,8],
    '949_Mavi_OVER':[36,3,15,45,5,13],'949_Mavi_UNDER':[32,1,3,13,46,47],
    '949_Mor_OVER':[42,43,33,40,3,27],'949_Mor_UNDER':[1,43,3,12,17,38],
    '949_Sari_OVER':[38,6,32,13,37,22],'949_Sari_UNDER':[12,39,48,9,34,19],
    '949_Siyah_OVER':[30,6,14,32,45,46],'949_Siyah_UNDER':[24,12,26,27,37,48],
    '949_Turuncu_OVER':[47,2,3,6,23,25],'949_Turuncu_UNDER':[5,24,15,2,3,20],
    '949_Yesil_OVER':[1,16,25,34,39,4],'949_Yesil_UNDER':[27,21,32,35,46,6],
    '950_Kahve_OVER':[3,8,15,28,12,39],'950_Kahve_UNDER':[31,34,41,3,17,20],
    '950_Kirmizi_OVER':[37,42,4,38,8,31],'950_Kirmizi_UNDER':[19,28,36,39,46,5],
    '950_Mavi_OVER':[40,12,3,9,8,13],'950_Mavi_UNDER':[46,16,9,45,8,29],
    '950_Mor_OVER':[15,11,31,2,6,35],'950_Mor_UNDER':[33,16,41,4,25,37],
    '950_Sari_OVER':[14,2,8,11,40,45],'950_Sari_UNDER':[30,48,1,4,5,7],
    '950_Siyah_OVER':[13,10,24,6,30,33],'950_Siyah_UNDER':[6,41,35,2,18,24],
    '950_Turuncu_OVER':[41,33,36,9,21,42],'950_Turuncu_UNDER':[18,39,1,41,11,15],
    '950_Yesil_OVER':[5,19,21,22,6,29],'950_Yesil_UNDER':[5,17,43,24,47,14],
    '951_Kahve_OVER':[27,10,24,34,25,39],'951_Kahve_UNDER':[13,35,22,38,6,19],
    '951_Kirmizi_OVER':[46,47,19,34,17,30],'951_Kirmizi_UNDER':[41,35,27,33,42,9],
    '951_Mavi_OVER':[13,8,40,37,10,31],'951_Mavi_UNDER':[39,8,9,20,45,47],
    '951_Mor_OVER':[31,12,30,15,27,35],'951_Mor_UNDER':[5,2,20,21,38,40],
    '951_Sari_OVER':[6,4,15,35,48,18],'951_Sari_UNDER':[14,18,20,2,43,23],
    '951_Siyah_OVER':[2,28,40,1,13,41],'951_Siyah_UNDER':[16,42,6,7,11,39],
    '951_Turuncu_OVER':[24,34,36,40,5,8],'951_Turuncu_UNDER':[46,20,11,8,26,31],
    '951_Yesil_OVER':[15,12,9,30,40,44],'951_Yesil_UNDER':[45,23,47,1,25,28],
    '952_Kahve_OVER':[36,39,3,44,10,24],'952_Kahve_UNDER':[19,3,26,37,20,22],
    '952_Kirmizi_OVER':[13,18,28,37,47,21],'952_Kirmizi_UNDER':[11,26,6,13,16,21],
    '952_Mavi_OVER':[28,7,38,43,10,15],'952_Mavi_UNDER':[7,19,13,18,35,47],
    '952_Mor_OVER':[32,44,2,9,3,20],'952_Mor_UNDER':[1,12,21,28,2,5],
    '952_Sari_OVER':[25,42,4,20,22,23],'952_Sari_UNDER':[10,26,36,40,41,48],
    '952_Siyah_OVER':[43,11,23,4,18,22],'952_Siyah_UNDER':[30,40,16,9,46,47],
    '952_Turuncu_OVER':[19,41,21,5,29,34],'952_Turuncu_UNDER':[46,37,38,1,33,3],
    '952_Yesil_OVER':[42,5,13,16,43,11],'952_Yesil_UNDER':[43,9,36,5,16,39],
    '953_Kahve_OVER':[24,25,33,42,15,20],'953_Kahve_UNDER':[48,12,30,46,16,27],
    '953_Kirmizi_OVER':[10,37,24,25,7,9],'953_Kirmizi_UNDER':[9,17,25,4,27,28],
    '953_Mavi_OVER':[45,7,13,41,24,25],'953_Mavi_UNDER':[4,28,31,40,45,3],
    '953_Mor_OVER':[47,27,28,31,9,11],'953_Mor_UNDER':[11,14,15,22,33,46],
    '953_Sari_OVER':[3,13,14,16,28,38],'953_Sari_UNDER':[44,22,11,17,18,35],
    '953_Siyah_OVER':[1,4,5,30,37,7],'953_Siyah_UNDER':[40,6,12,17,29,33],
    '953_Turuncu_OVER':[42,36,39,44,47,2],
    '953_Yesil_OVER':[8,45,1,23,6,12],'953_Yesil_UNDER':[47,6,7,21,28,32]
  };

  // NOT: Anahtar MEVCUT çekilişin MS+Renk+OU'su
  // predMs = şu anki MS, predColor = şu anki renk, predOU = şu anki OU
  var currKey = predMs + '_' + predColor + '_' + predOU;
  var c6FromTable = CURR_TO_NEXT_C6[currKey] || null;

  if (c6FromTable && c6FromTable.length === 6) {
    result.certain6 = c6FromTable.slice().sort(function(a,b){return a-b;});
  } else {
    // Fallback: genel iyi sayılar
    var fallback6 = [3,8,12,19,28,41];
    result.certain6 = fallback6.sort(function(a,b){return a-b;});
  }
